...
EVIDENCE_NODE_SCHEMA = {
    ...
    "properties": {
        ...
        "locator": {"anyOf": [{"type": "string"}, {"type": "object"}]},
        "citation": {"type": "string"},
    },
    "required": ["id", "kind", "run_id", "source_ids", "metric_ids", "title", "content", "summary", "data", "time_scope", "spatial_scope", "method", "quality_flags", "locator", "citation"],
    ...
    "properties": {
        "hits": {
            ...
            "items": {
                ...
                "required": ["node_id", "source_ids", "kind", "score", "evidence_node"],
                "additionalProperties": False,
            },
        }
    },
...
READ_EVIDENCE_NODE_SCHEMA = {
    ...
    "required": ["node_id", "source_ids", "kind", "evidence_node"],
    "additionalProperties": False,
}
